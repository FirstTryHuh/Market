    ...
    return (<header className={style.header}>
        <div className={style.middle}>
            ...
            : <div className={style.user}>
                ...
                <button onClick={() => signOut({ callbackUrl: '/' })} className="z-2 inline-flex items-center justify-center rounded-md text-sm font-medium h-9 px-4 py-2 bg-gray-800 hover:bg-gray-700 text-gray-200">Sign out</button>
            </div>
            }
        </div>
    </header>
