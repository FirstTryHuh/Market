        ...
        <div className={style.middle}>
            ...
            {status == 'loading' ? null : !Session
                ? <div className='flex gap-2'>
                    <Link onClick={() => SetSigned(true)} href="/new" className="z-2 inline-flex items-center justify-center rounded-md text-sm font-medium h-9 px-3 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 whitespace-nowrap">Log in</Link>
                    <Link onClick={() => SetSigned(false)} href="/new" className="z-2 hidden sm:inline-flex items-center justify-center rounded-md text-sm font-medium h-9 px-3 py-2 bg-orange-500 hover:bg-orange-600 text-white whitespace-nowrap">Sign Up</Link>
                </div>
