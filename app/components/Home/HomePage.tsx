        ...
        <div className={style.item}>
          <div className={style.Hold}>
            <div className={style.FlexSm}>
              ...
              <div className={style.SubHead}>Ready to buy? Or just browsing for inspiration? Either way, drop what you&apos;re looking for into the search bar and let&apos;s go.</div>
            </div>
            <FindingBar home={false}/>
            <form className="flex flex-wrap gap-1 mt-4" action="submit">
