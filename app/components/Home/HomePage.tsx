        ...
        <div className={style.item}>
          <div className={style.Hold}>
            <div className={style.FlexSm}>
              ...
              <div style={{fontSize:"1.2rem"}}>Ready to buy? Or just browsing for inspiration? Either way, drop what you're looking for into the search bar and let's go.</div>
            </div>
            <FindingBar home={false}/>
            <form className="flex gap-1 mt-4" action="submit">
              <div style={{fontWeight:"700",paddingRight:"1rem",fontSize:"1.4rem"}}>Popular</div>
