            ...
            <div className="lg:col-span-1">
              ...
              <div className="mt-10 space-y-6">
                <div className="flex gap-x-4">
                  ...
                  <dd>
                    <a className="text-base leading-7 text-gray-600 hover:text-gray-900" href="mailto:thanhnguyen507ct@gmail.com">
                ...
                <div className="flex gap-x-4">
                  ...
                  <dd>
                    <a className="text-base leading-7 text-gray-600 hover:text-gray-900" href="tel:+1 (555) 123-4567">
                      +84 (039) 382-3716
                    </a>
                  </dd>
                </div>
